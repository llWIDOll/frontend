...
export default function OrderKanban({ initialOrders, restaurantId }: { initialOrders: any[], restaurantId: string }) {
  ...
  // Sync state with server-side props refresh (when revalidatePath occurs)
  useEffect(() => {
